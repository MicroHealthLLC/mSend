...
include('header-unlogged.php');
    ...
    // var_dump($guestallowed_file_types);die();
 ...
 * Remove "zip" from File Extensions Allowed only for Guest Drop-Off Summary 

*/

// $allowed_file_types_search=array_search(strtolower('ZIP'), array_map('strtolower', $allowed_file_types));

// if($allowed_file_types_search==true){

//     $allowed_file_types_search=array_splice($allowed_file_types,$allowed_file_types_search);
        ...
        if($duplicate_access) {
...

            {
...

                {
                    ...
                    if($file_status) {
                        $altzipRealName=str_replace("_.zip",".zip",$zipRealName);
                        $RealzipName=$altzipRealName;
