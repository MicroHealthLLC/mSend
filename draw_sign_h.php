...
//echo "<pre>";print_r($_POST);echo "</pre>";exit;
    ...
    if($sig_status==1 && $sigdate_status==1){
        ...
        <tr>
                                        ...
                                        <tr>
                                          <td align='left' style='font-family:sans-serif;font-size:14px;vertical-align:top;padding-bottom:15px;'>
                                            <table border='0' cellpadding='0' cellspacing='0' style='border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;width:auto;'>
                                              <tbody>
                                                <tr>
                                                  <td style='font-family:sans-serif;font-size:14px;vertical-align:top;background-color:#ffffff;border-radius:5px;text-align:center;background-color:#3498db;'> <a href='".BASE_URI."sign_document.php?auth=".$randkey."' target='_blank' style='text-decoration:underline;background-color:#ffffff;border:solid 1px #3498db;border-radius:5px;box-sizing:border-box;color:#3498db;cursor:pointer;display:inline-block;font-size:14px;font-weight:bold;margin:0;padding:12px 25px;text-decoration:none;text-transform:capitalize;background-color:#3498db;border-color:#3498db;color:#ffffff;'>go</a> </td>
                                                </tr>
                                              </tbody>
                                            </table>
                                          </td>
             ...
             */
            if($send_mail->Send()) {
                 echo '<script>window.location.href="create_signature_spot_h.php?pdf_name='.$pname.'&id='.$log_user_id.'&req_id='.$drop_off_request_id.'&mail_status=true"</script>';
                ...
                // $cc_status = "<div class=\"alert alert-success cc-success\"><strong>Success! </strong>Your Request has been submitted successfully.</div>";
                 ...
                 echo '<script>window.location.href="create_signature_spot_h.php?pdf_name='.$pname.'&id='.$log_user_id.'&req_id='.$drop_off_request_id.'&mail_status=false"</script>';
    ...
    <div class="container">
        <div class="row">
                ...
                ?>
                        ...
                        <img width = "<?php echo $image_width;?>" src="<?php echo BASE_URI."upload/files/newrequest/".$log_user_id."/". $image_name; ?>" >
