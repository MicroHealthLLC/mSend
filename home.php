          ...
          <div class="col-sm-8 <?php if ($show_log != true) { echo 'col-sm-offset-2'; } ?>">
            <div class="row">
              <div class="col-sm-12">
                <div class="widget">
                  <h4>
                    <?php _e('Statistics','cftp_admin'); ?>
                  </h4>
                  <div class="widget_int">
                    <ul class="graph_legend">
                      <li class="legend_color legend_color1" title="<?php _e('Uploads by users','cftp_admin'); ?>">
                        <div class="ref_color"></div>
                        <i class="fa fa-upload" aria-hidden="true"></i>
                        <?php _e('Uploads by users','cftp_admin'); ?>
                      </li>
                      ...
                      <li class="legend_color legend_color4" title="<?php _e('Zip Downloads','cftp_admin'); ?>">
                        <div class="ref_color"></div>
                        <i class="fa fa-file-archive-o" aria-hidden="true"></i>
                        <?php _e('Zip Downloads','cftp_admin'); ?>
                      </li>
                      <li class="legend_color legend_color5" title="<?php _e('Public Downloads','cftp_admin'); ?>">
                        <div class="ref_color"></div>
                        <i class="fa fa-users" aria-hidden="true"></i>
                        <?php _e('Public Downloads','cftp_admin'); ?>
                      </li>
                    </ul>
                    <div class="stats_change_days"> <a href="#" class="stats_days btn btn-sm btn-default" rel="15" id="default_graph">15
                      <?php _e('days','cftp_admin'); ?>
                      </a> <a href="#" class="stats_days btn btn-sm btn-default" rel="30">30
                      <?php _e('days','cftp_admin'); ?>
                      </a> <a href="#" class="stats_days btn btn-sm btn-default" rel="60">60
                      <?php _e('days','cftp_admin'); ?>
                      </a> </div>
           ...
           <div class="col-sm-6">
                <div class="widget">
                  <h4>
                    <?php _e('System data','cftp_admin'); ?>
                  </h4>
                  <div class="widget_int">
                    <p><strong>
                      <?php _e('Note:','cftp_admin'); ?>
                      </strong>
                      <?php _e('This graphic will help you get a relative view of the existing data, allowing you to see the relation between clients, users, groups and files.','cftp_admin'); ?>
              ...
              <div class="widget_int">
                <div class="log_change_action"> <a href="#" class="log_action btn btn-sm btn-default" rel="" id="default_log">
                  ...
                  <?php
										...
										?>
                  <a href="#" class="log_action btn btn-sm btn-default" rel="4">
                  <?php _e('Clients self-registrations','cftp_admin'); ?>
                  </a>
                  <?php
											}
										?>
                ...
                <div class="view_full_log"> <a href="actions-log.php" class="btn btn-primary btn-wide">
                  <?php _e('View all','cftp_admin'); ?>
                  </a> </div>
              </div>
            </div>
          </div>
